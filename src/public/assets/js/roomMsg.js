...
const addUserTable = (user) => {
    ...
    if (imAdmin) {
        ...
        newTdA_i.classList.add('bi', 'bi-star');
        newTdA_a.appendChild(newTdA_i);
        newTdA_a.title = 'Transferir administrador'
        
        // Add all buttons to the actions td
        newTdActions.appendChild(newTdK_a);
        newTdActions.appendChild(newTdB_a);
        newTdActions.appendChild(newTdA_a);
    }
